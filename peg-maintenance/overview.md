...
In practice, Beanstalk does not calculate the price of 1 Bean. Instead, at the beginning of each Season, Beanstalk calculates the liquidity and time weighted average shortage or excess of Beans in the BEAN:3CRV pool over the previous Season (i.e., deltaB).
