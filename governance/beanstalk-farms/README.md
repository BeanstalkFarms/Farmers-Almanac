...
See [#bfcp](../proposals.md#bfcp "mention") for more info on each BFCP proposal type.

BFCPs are proposed on the **Beanstalk Farms Snapshot** page:
...
See [#bfbp](../proposals.md#bfbp "mention") for more info on each proposal type.

BFBPs are proposed on the **Beanstalk Farms Budget Snapshot** page:
