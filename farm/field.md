...
Pods Ripen into Harvestable Pods that can be Harvested (redeemed) for 1 Bean each on a First In, First Out ([FIFO](../protocol-resources/glossary.md#fifo)) basis. There is no penalty for waiting to Harvest Pods.
